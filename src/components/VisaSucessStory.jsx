...
export default function VisaSection() {
  ...
  // Updated images array with student name & university
  const images = [
    {
      src: story1,
    ...
    { src: story1, name: "Ali Rahman", university: "Asia Pacific University" },
    { src: story1, name: "Sara Ahmed", university: "Multimedia University" },
    { src: story1, name: "Tanvir Hossain", university: "Taylor's University" },
    { src: story1, name: "Nabila Khan", university: "University of Malaya" },
  ];
